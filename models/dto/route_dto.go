...
type RouteResponseDTO struct {
	...
	DriverUUID       string `json:"user_uuid,omitempty" db:"driver_uuid"`
	UserUsername     string `json:"user_username,omitempty" db:"user_username"` // Field untuk username driver
